...
class ScheduleEvent(Event):
    ...
    def execute(self):
        ...
        time_to_pickup, time_to_dropoff = Scheduler.assign_ride(self.ride_id, self.bus_id, self.origin_node, self.destination_node)
        ...
        Scheduler.pass_events(pickup_event, dropoff_event)
