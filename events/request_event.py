...
class RequestEvent(Event):
    ...
    def execute(self):
        ...
        schedule_event = ScheduleEvent(ts=self.ts + 5, ride_id=self._id, origin_node=self.origin_node, destination_node=self.destination_node)
    ...
    def __repr__(self):
        return f"(0,{self.getId()},{self.ts},{self.origin_node},{self.destination_node})"
